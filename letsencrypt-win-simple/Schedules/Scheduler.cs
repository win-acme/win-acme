    ...
    public class Scheduler
    {
        public static void EnsureTaskScheduler()
        {
            ...
            using (var taskService = new TaskService())
            {
                ...
                {
                    addTask = false;
                    if (!$"\nDo you want to replace the existing {taskName} task?".PromptYesNo())
                        return;
                    addTask = true;
                ...
                if (addTask == true)
                {
                    ...
                    if (!App.Options.UseDefaultTaskUser && $"\nDo you want to specify the user the task will run as?".PromptYesNo())
                    {
