...
{
    internal class WebDavFactory : BaseHttpValidationFactory<WebDav, WebDavOptions>
    {
        public WebDavFactory(ILogService log, IISClient iisClient) : base(log, iisClient) { }
