...
{
    internal class ScriptFactory : BaseValidationPluginFactory<Script, ScriptOptions>
    {
        public ScriptFactory(ILogService log) : base(log, Dns01ChallengeValidationDetails.Dns01ChallengeType) { }
