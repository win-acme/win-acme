...
& dotnet publish $RepoRoot\src\main\wacs.csproj -c "Release" -r win-x64 --self-contained /p:PublishSingleFile=true /p:PublishTrimmed=true /p:IncludeNativeLibrariesForSelfExtract=true
& dotnet publish $RepoRoot\src\main\wacs.csproj -c "Release" -r win-x86 --self-contained /p:PublishSingleFile=true /p:PublishTrimmed=true /p:IncludeNativeLibrariesForSelfExtract=true
& dotnet publish $RepoRoot\src\main\wacs.csproj -c "Release" -r win-arm64 --self-contained /p:PublishSingleFile=true /p:PublishTrimmed=true /p:IncludeNativeLibrariesForSelfExtract=true
